<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search-students.aspx.cs" Inherits="search_students" %>
  ...
  <header>
    ...
    <asp:Label ID="lblUserName2" runat="server" CssClass="welcome-label2"> </asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <h2 class="head">🎓STUDENTS RECORDS </h2>
             <div class="container">
    ...
    <asp:TextBox ID="TextBox1"
        ...
        Textmode="Search"
        CssClass="search-box"
        Placeholder="Search by Roll No, Reg No, Name .........."
        AutoPostBack="True"
...
&nbsp;&nbsp;<asp:Label ID="Label4" runat="server" Text="Branch" CssClass="label" Width="70px"></asp:Label>
                 &nbsp<asp:DropDownList ID="DropDownList4" runat="server" CssClass="DD" Width="100px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged" ></asp:DropDownList>
&nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="Sem" CssClass="label" Width="50px"></asp:Label>
                 &nbsp<asp:DropDownList ID="DropDownList5" runat="server" CssClass="DD" width="100px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged" ></asp:DropDownList>

                                  <div class="grid-container">
                                      <asp:GridView ID="GridView1"
    runat="server"
    AutoGenerateColumns="False"
    DataKeyNames="clg_roll_no"
    OnRowCommand="GridView1_RowCommand"
    OnRowDataBound="GridView1_RowDataBound">

    <Columns>

        <asp:BoundField DataField="clg_roll_no" HeaderText="College Roll No" />
<asp:BoundField DataField="uni_reg_no" HeaderText="University Reg No" />
<asp:BoundField DataField="student_name" HeaderText="Student Name" />

<asp:BoundField DataField="branch_class" HeaderText="Branch" />
<asp:BoundField DataField="sem_year" HeaderText="Semester" />
        ...
        <asp:TemplateField HeaderText="Delete">
            <ItemTemplate>
                ...
                <asp:LinkButton
                    ...
                    CommandArgument='<%# Eval("clg_roll_no") %>'>
                </asp:LinkButton>
