 ...
 <header>
          ...
          <li>
              <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <asp:HyperLink ID="HyperLink3" runat="server" Text="Hyperlink" NavigateUrl="~/Book-status.aspx">Book Status</asp:HyperLink>                    
                </div>
            </div>
          </li>
            <li>
    ...
    <asp:Label ID="lblUserName2" runat="server" CssClass="welcome-label2"> </asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server" >
            <h2 class="head">🎓 MANAGE STUDENT </h2>
             <div class="container">
                 <div class="content1">
                 <asp:Label ID="Label1" runat="server" Text="Clg Roll No " CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox1" runat="server" CssClass="myTextbox" placeholder="College Roll No"></asp:TextBox>
                
                 <asp:Label ID="Label2" runat="server" Text="Uni Reg No " CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox2" runat="server" CssClass="myTextbox" placeholder="University Registration Number"></asp:TextBox>
                 
                 <asp:Label ID="Label3" runat="server" Text="Student Name " CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox3" runat="server" CssClass="myTextbox" placeholder="Student Name"></asp:TextBox>
               
                 <asp:Label ID="Label4" runat="server" Text="Branch/Class" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox4" runat="server" CssClass="myTextbox" placeholder="Branch/Class"></asp:TextBox>
                 
                 <asp:Label ID="Label5" runat="server" Text="Sem/Year" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox5" runat="server" CssClass="myTextbox" placeholder="Sem or year"></asp:TextBox>
                
                 <asp:Label ID="Label6" runat="server" Text="Father's Name" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox6" runat="server" CssClass="myTextbox" placeholder="Father's Name"></asp:TextBox>
                 <asp:Label ID="Label7" runat="server" Text="Address" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox7" runat="server" CssClass="myTextbox" TextMode="MultiLine" Rows="2" placeholder="Address"></asp:TextBox>
                 </div>
                 <div class="content2">
                 <asp:Label ID="Label8" runat="server" Text="DOB" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox8" runat="server" CssClass="myTextbox" TextMode="Date"></asp:TextBox>
                 ...
                 <asp:Label ID="Label9" runat="server" Text="Email ID" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox9" runat="server" CssClass="myTextbox" TextMode="Email" placeholder="Email"></asp:TextBox>
                 <asp:Label ID="Label10" runat="server" Text="Contact NO" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox10" runat="server" CssClass="myTextbox" MaxLength="11" TextMode="Phone" placeholder="Contact Number"></asp:TextBox>
                 <asp:CheckBox ID="CheckBox1" runat="server" Text="IS ACTIVE STUDENT" />
                     <fieldset>
                         <legend>🔍SEARCH FOR</legend>
                         <asp:Label ID="Label11" runat="server" Text="🔍Clg Roll No For Search" CssClass="mylable"></asp:Label>
                         <asp:TextBox ID="TextBox11" runat="server" CssClass="myTextbox" TextMode="Search" placeholder="For eg: VLB25-001" AutoPostBack="true"
