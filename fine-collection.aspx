<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fine-collection.aspx.cs" Inherits="fee_collection" %>
...
<asp:BoundField DataField="for_days" HeaderText="Late Days" />
<asp:BoundField DataField="fine" HeaderText="Fine (₹)" />

<asp:BoundField DataField="issued_or_returned" HeaderText="Status" />
