<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher-issue-book.aspx.cs" Inherits="teacher_issue_book" %>
  ...
  <header>
    ...
    <asp:Label ID="lblUserName2" runat="server" CssClass="welcome-label2"> </asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <h2 class="head">👩‍🏫Teacher Issue </h2>
             <div class="container">
                 <div class="content1">
                    ...
                    <asp:TextBox ID="TextBox2"  AutoPostBack="true" OnTextChanged="TextBox2_TextChanged" runat="server" CssClass="myTextbox" placeholder="For eg: VLB-BK-0001"></asp:TextBox>
                    <asp:Label ID="Label3" runat="server" Text=" Author" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox3" runat="server" CssClass="myTextbox" placeholder="Author"></asp:TextBox>
                    <asp:Label ID="Label4" runat="server" Text=" Title" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox4" runat="server" CssClass="myTextbox" placeholder="Title"></asp:TextBox>
                    <asp:Label ID="Label5" runat="server" Text=" Publishe" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox5" runat="server" CssClass="myTextbox" placeholder="Publisher"></asp:TextBox>
                    <asp:Label ID="Label6" runat="server" Text=" Subject" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox6" runat="server" CssClass="myTextbox" placeholder="Subject"></asp:TextBox>
                    <asp:Label ID="Label7" runat="server" Text=" Price" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox7" runat="server" CssClass="myTextbox" placeholder="Price"></asp:TextBox>
                </div>
                <div class="content2">
                    <asp:Label ID="Label8" runat="server" Text="Issue Date" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox8" runat="server" CssClass="myTextbox" TextMode="Date"></asp:TextBox>
                    <asp:Label ID="Label9" runat="server" Text="Teacher ID " CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox9" AutoPostBack="true" OnTextChanged="TextBox9_TextChanged" runat="server" CssClass="myTextbox" placeholder="For eg: VLB-TCH-0001"></asp:TextBox>
                    <asp:Label ID="Label10" runat="server" Text="Teacher Name" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox10" runat="server" CssClass="myTextbox" placeholder="Teacher Name"></asp:TextBox>
                    <asp:Label ID="Label11" runat="server" Text="Department" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox11" runat="server" CssClass="myTextbox" placeholder="Department"></asp:TextBox>
                    <asp:Label ID="Label12" runat="server" Text="Email ID" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox12" runat="server" CssClass="myTextbox" TextMode="Email" placeholder="Email ID"></asp:TextBox>
                    <asp:Label ID="Label13" runat="server" Text=" Contact No." CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox13" runat="server" CssClass="myTextbox" TextMode="Phone" MaxLength="11" placeholder="Contact No"></asp:TextBox>
                    <asp:Label ID="Label14" runat="server" Text=" For Days" CssClass="mylable"></asp:Label>
                    <asp:TextBox ID="TextBox14" runat="server" CssClass="myTextbox" TextMode="Number" placeholder="For Days"></asp:TextBox>
                </div>  
                 <div class="button">
