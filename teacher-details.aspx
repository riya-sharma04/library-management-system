<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher-details.aspx.cs" Inherits="teacher_details" %>
  ...
  <header>
    ...
    <asp:Label ID="lblUserName2" runat="server" CssClass="welcome-label2"> </asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <h2 class="head">👩‍🏫 MANAGE TEACHER </h2>
            <div class="container">
                 <div class="content1">
                 <asp:Label ID="Label1" runat="server" Text="Techer ID " CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox1" runat="server" CssClass="myTextbox" placeholder="Teacher ID"></asp:TextBox>
                
                 <asp:Label ID="Label2" runat="server" Text="Teacher Name" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox2" runat="server" CssClass="myTextbox" placeholder="Teacher Name"></asp:TextBox>
                 
                 <asp:Label ID="Label3" runat="server" Text="Department" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox3" runat="server" CssClass="myTextbox" placeholder="Department"></asp:TextBox>
               
                 <asp:Label ID="Label4" runat="server" Text="Designation" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox4" runat="server" CssClass="myTextbox" placeholder="Designation"></asp:TextBox>
                 
                 <asp:Label ID="Label5" runat="server" Text="Experience" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox5" runat="server" CssClass="myTextbox" TextMode="Number" placeholder="Experience in years"></asp:TextBox>
                
                 <asp:Label ID="Label6" runat="server" Text="Qualification" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox6" runat="server" CssClass="myTextbox" placeholder="Qualification"></asp:TextBox>
                 ...
                 <asp:TextBox ID="TextBox9" runat="server" CssClass="myTextbox" TextMode="Email" placeholder="Email ID"></asp:TextBox>
                 ...
                 <asp:CheckBox ID="CheckBox1" runat="server" Text="IS ACTIVE FACULTY" />
                 <fieldset>
                 <legend>🔍SEARCH FOR</legend>
                 <asp:Label ID="Label11" runat="server" Text="🔍Teacher ID for Search" CssClass="mylable"></asp:Label>
                 <asp:TextBox ID="TextBox11" runat="server" CssClass="myTextbox" TextMode="Search" placeholder="For eg: VLB-TCH-0001" AutoPostBack="true"
